import matanTorahAsset from "@/assets/matan-torah.pdf.asset.json";
import eretzYisraelAsset from "@/assets/eretz-yisrael.pdf.asset.json";
import scharVOneshAsset from "@/assets/schar-v-onesh.pdf.asset.json";
import newsletterIssueAsset from "@/assets/yyh-newsletter-issue-2.pdf.asset.json";
import foundingTheFutureAsset from "@/assets/founding-the-future.pdf.asset.json";

const matanTorah = matanTorahAsset.url;
const eretzYisrael = eretzYisraelAsset.url;
const scharVOnesh = scharVOneshAsset.url;
const newsletterIssue = newsletterIssueAsset.url;
const foundingTheFuture = foundingTheFutureAsset.url;
